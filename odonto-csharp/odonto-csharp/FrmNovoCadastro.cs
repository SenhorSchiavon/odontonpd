...
namespace odonto_csharp
{
    public partial class FrmNovoCadastro : Form
    {
        ...
        {
            conexao = new SQLiteConnection("Data Source=C:\\Users\\Capitao\\Desktop\\projeto-odonto-npd-main\\odonto-csharp\\odonto-csharp\\banco\\banco_odonto");
            conexao.Open();
            return conexao;
        }
        ...
        private void InserirOuAtualizarPaciente()
        {
            using (var connection = ConexaoBanco())
            {
                ...
                using (var cmd = connection.CreateCommand())
                {
                    ...
                    cmd.Parameters.AddWithValue("@data", dateCadastro.Value.ToString("dd/MM/yyyy"));
